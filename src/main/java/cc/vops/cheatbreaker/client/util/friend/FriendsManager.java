package cc.vops.cheatbreaker.client.util.friend;
...
public class FriendsManager {
    ...
    public void addUnreadMessage(String playerId, String message) {
        ...
        String prefix = "§7" + LocalDateTime.now().format(this.timeFormatter);
        String suffix = "§c" + friend.getName() + "§r";
    ...
    public void addOutgoingMessage(String playerId, String message) {
        ...
        String prefix = "§7" + LocalDateTime.now().format(this.timeFormatter);
        String suffix = "§b" + Minecraft.getInstance().getUser().getName() + "§r";
        String concat = prefix + " " + suffix + ": " + message;
