package cc.vops.cheatbreaker.client.event;
...
public class EventBus {
    ...
    public void callEvent(final Event event) {
        try {
                ...
                if (list != null) {
                    list.forEach(consumer -> {
                        try {
                            ...
                            CheatBreaker.LOGGER.info("EventBus [" + event.getClass() + "] Consumer [" + consumer.getClass() + "]");
                            ex.printStackTrace();
                        }
                    });
                }
            ...
            CheatBreaker.LOGGER.info("EventBus [" + event.getClass() + "]");
            ex.printStackTrace();
        }
    }
