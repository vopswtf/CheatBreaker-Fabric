...
public abstract class WSPacket {
    ...
    public abstract void handle(AssetsWebSocket socket);
    ...
    protected byte[] readKey(ByteBuf byteBuf) {
        ...
        CheatBreaker.LOGGER.info("[WS] Key was smaller than nothing! Weird key!");
        return new byte[0];
    }

    static {
        REGISTRY.put(WSPacketWelcome.class, 999);
        REGISTRY.put(WSPacketHello.class, 1000);
        REGISTRY.put(WSPacketAuthChallenge.class, 1001);
        REGISTRY.put(WSPacketAuthChallengeResponse.class, 1002);
        ...
        REGISTRY.put(WSPacketEmote.class, 38);
    }
